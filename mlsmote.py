...
class MLSMOTE:
    ...
    .. [1] Charte, F. & Rivera Rivas, Antonio & Del Jesus, María José & Herrera,
        ...
        [2] https://github.com/scikit-learn-contrib/imbalanced-learn/blob/70e1f966414cdf9425d764c52a0a92d99c732051/imblearn/over_sampling/_mlsmote.py 
    """
    ...
    def fit_resample(self, X, y):
        ...
        X_resampled = pd.DataFrame(X_resampled, columns=self.input_columns)
        y_resampled = pd.DataFrame(y_resampled, columns=self.label_columns)
